        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="flex flex-col items-center gap-6">
            ...
            <div className="w-full space-y-4">
              <FactorMeter label="Rule adherence" score={discipline.ruleAdherence} />
              <FactorMeter label="Session adherence" score={discipline.sessionAdherence} />
              <FactorMeter label="Overtrading prevention" score={discipline.overtradingPrevention} />
              <FactorMeter label="Risk management" score={discipline.riskManagement} />
            </div>
          </CardContent>
        </Card>
